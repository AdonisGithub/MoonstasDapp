  ...
  return (
    <>
      {countdownEnable === true && (
        <Grid
          container
          style={{ position: "absolute", top: "-30px", left: "0px",textAlign:"center" }}
        >
      ...
      <Grid container className="mintHeader" alignItems="center">
        <Grid>
          <Typography
            variant="h5"
            style={{ fontWeight: 600, textAlign: "center", marginTop:'12px' }}
            className="pb-2"
          >
            {phaseName}
          </Typography>
      ...
      {desc && (
        <Typography className="pb-2" variant="body1" color="textSecondary" style={{textAlign:'center'}}>
          {desc}
        </Typography>
      )}
    </>
