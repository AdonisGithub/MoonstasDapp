...
export const welcomeSettings: WelcomeSettings = {
  ...
  countdownTo: date("1 May 2022 00:00:00 GMT"),
  //Example date below
...
export const whitelistSettings: WhitelistSettings = {
  ...
  startDate: date("5 May 2022 00:00:00 GMT"),
  endDate: date("15 May 2022 00:00:00 GMT"),
  countdown: true,
  //Example date below
  // date('29 2021 00:00:00 GMT')
...
export const publicSaleSettings: PublicSaleSettings = {
  ...
  startDate: date("15 May 2022 00:00:00 GMT"),
  endDate: undefined,
  countdown: false,
  //Example date below
  // date('29 2021 00:00:00 GMT')
